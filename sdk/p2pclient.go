...
// MaxMsgSize is the max size of a message in this P2P network.
...
func GetP2PClient(magic, maxMsgSize uint32, clientId uint64, seeds []string, port uint16, minOutbound, maxConnections int) (P2PClient, error) {
	return NewP2PClientImpl(magic, maxMsgSize, clientId, seeds, port, minOutbound, maxConnections)
}
