...
type SPVService interface {
	...
	SendTransaction(ioex.Transaction) (*common.Uint256, error)
}
...
type SPVHandler interface {
	...
	GetData() ([]*common.Uint168, []*ioex.OutPoint)
